...
fun HttpTracer(actorFrom: TraceActorResolver) = Tracer { parent, rest, tracer ->
    parent
...
private fun MetadataEvent.toTrace(actorFrom: TraceActorResolver, rest: List<MetadataEvent>, tracer: Tracer): Trace {
